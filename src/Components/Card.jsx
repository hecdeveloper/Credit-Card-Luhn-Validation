...
const Card = ({ cardNumber, cardName, expiration,ccv, cardType, isEmpty }) => {
  return (
    ...
    {cardType === "Mastercard" && !isEmpty  && <img className="card-logo" src={mLogo} alt="Mastercard Logo" />}
        {cardType === "Visa" && !isEmpty &&  <img className="card-logo" src={vLogo} alt="Visa Logo" />}
